/**
 * frorm https://github.com/pietrop/digital-paper-edit-electron/tree/master/src/ElectronWrapper/lib/av-metadata-reader
 ...
 * @example <caption>Example usage</caption>
 ...
 const sampleVideo = "sampleVideo.mov";
readMetadataForEDL({
  file: sampleVideo,
    ...
    ffmpeg.ffprobe(file, (err, metadata) => {
      ...
      if (metadata !== undefined && metadata.streams[0] !== undefined && metadata.streams[0].r_frame_rate !== undefined) {
        ...
        if (video.r_frame_rate !== '0/0') {
          ...
          if (!isNaN(firstNumber / lastNumber)) {
